...
# TRAINED_TOKENIZERS = [f"{BASEFOLDER}/llama3-tokenizer-twitter-raw/{vocab_size}" for vocab_size in [1000, 4000, 128000, 512000]]
# TRAINED_TOKENIZERS = [f"{BASEFOLDER}/llama3-tokenizer-twitter-raw/{vocab_size}" for vocab_size in [500]]246000
TRAINED_TOKENIZERS = [f"{BASEFOLDER}/llama3-tokenizer-twitter-raw/{vocab_size}" for vocab_size in [500, 2000, 4000, 8000, 16000, 64000, 246000]]
# TRAINED_TOKENIZERS = [f"{BASEFOLDER}/llama3-tokenizer-twitter-raw/{vocab_size}" for vocab_size in [246000]]