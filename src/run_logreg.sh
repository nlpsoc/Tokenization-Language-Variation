...
# ------------------ SENTENCE BERTS -----------------------------------
#SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/LOGREG_sadiri_test-set_%j.txt
...
# python run_logreg.py --task "mnli-mVALUE,qnli-mVALUE"  --tokenizer_paths "all"
python run_logreg.py --task "NUCLE"  --tokenizer_paths "all" --on_test_set
# python run_logreg.py --task "simplification"  --tokenizer_paths "all"
