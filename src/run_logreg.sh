...
# python run_logreg.py --task "multi-DIALECT"  --tokenizer_paths  "all"
python run_logreg.py --task "mnli,mnli-textflint,mnli-mVALUE"  --tokenizer_paths  "/hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/tokenizer/mixed-gpt2-32000/tokenizer.json"