...
# ------------------ SENTENCE BERTS -----------------------------------
#SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/LOGREG_NUCLE_%j.txt
...
# python run_logreg.py --task "sst2-textflint,qqp-textflint,mnli-textflint,qnli-textflint"  --tokenizer_paths "all"
# python run_logreg.py --task "sst2-mVALUE,qqp-mVALUE,mnli-mVALUE,qnli-mVALUE"  --tokenizer_paths "all"
