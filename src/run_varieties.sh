...
# ------------------ SENTENCE BERTS -----------------------------------
#SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/VAR_3.3-75k-42_mixed-gpt2-500_VMRPC_42_%j.txt
...
SEED=42
python  run_varieties.py --model_name_or_path $MODEL_PATH --task_name $VALUE_TASK_NAME \
