...
# ------------------ SENTENCE BERTS -----------------------------------
### SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/VAR_mini-3.3-75k-42_mixed-llama3-32k_42_%j.txt
#SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/VALUE_tiny-42_mixed-gpt2-128k_%j.txt
