...
# ------------------ SENTENCE BERTS -----------------------------------
#SBATCH -o /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/VAR_3.3-75k-42_mixed-gpt2-64k_STEL-SADIRI-AGE_42_%j.txt
...
export VALUE_TASK_NAME=mrpc
 python run_transform_glue.py --task_name $VALUE_TASK_NAME --dialect "aave" --lexical_mapping $MAPPING_FILE --morphosyntax --model_path "" --output_dir /hpc/uu_cs_nlpsoc/02-awegmann/TOKENIZER/output/
#SEED=42
